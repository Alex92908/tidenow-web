...
export const STYLE_OPTIONS_EN: StyleOption[] = [
  ...
  { id: "humanity", icon: "🧠", label: "Human nature",    hint: "Psychology, motives, human dynamics" },
  { id: "erudite",  icon: "📚", label: "Erudite",         hint: "Cross-discipline depth, rich references" },
...
export const STYLE_OPTIONS_ZH: StyleOption[] = [
  ...
  { id: "humanity", icon: "🧠", label: "人性洞察",   hint: "从心理、动机、人性角度剖析" },
  { id: "erudite",  icon: "📚", label: "学识深度",   hint: "旁征博引，跨学科，知识密度高" },
