...
export function SourceCard({
  ...
  return (
    ...
    >
      ...
      {/* Header — two rows so long source names don't squeeze the actions.
          Row 1: icon + name (+ updated-at on the right).
          Row 2: drag handle / share / refresh / pin / hide, right-aligned. */}
